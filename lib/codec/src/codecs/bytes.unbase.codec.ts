 ...
 */
export function BytesUnbaseCodec(base: multibase.name): t.Type<Uint8Array, string, string> {
  const prefix = String.fromCharCode(multibase.encode(base, new Uint8Array())[0]);
