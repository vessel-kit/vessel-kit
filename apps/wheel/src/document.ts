import { AnchorProof, AnchorRecord, AnchorStatus, AnchorServiceResponse, DocState, InitOpts, DoctypeHandler } from '@potter/vessel'
import type Dispatcher from './dispatcher'
import type { AnchorService } from '@potter/anchor'
