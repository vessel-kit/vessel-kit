...
describe('keyMaterialFromDID', () => {
  ...
  test('publicKeyBase64', () => {
    ...
    expect(() => keyMaterialFromDID(publicKey)).toThrow(UnsupportedKeyEncodingError);
  });
  test('publicKeyPem', () => {
    const publicKey = Object.assign(
      {
...
describe('publicKeyFromDID', () => {
  ...
  test('ES256K', () => {
    const types = ['Secp256k1VerificationKey2018', 'EcdsaPublicKeySecp256k1', 'Secp256k1SignatureVerificationKey2018'];
    types.forEach((type) => {
